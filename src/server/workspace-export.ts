...
export const EXPORT_ENTITIES = ["clients", "websites", "audits", "audit_runs", "audit_findings", "audit_snapshots", "audit_category_scores", "opportunities", "monthly_cycles", "monthly_cycle_deliverables", "monthly_cycle_work_items", "reports", "monthly_reports", "agent_runs", "approval_requests", "execution_approvals", "execution_records", "implementation_packages", "manual_implementation_records", "implementation_verification_records", "ai_visibility_prompt_sets", "ai_visibility_prompts", "ai_visibility_runs", "ai_visibility_observations", "usage_ledger", "workspace_operations", "retention_cleanup_runs", "activity_events"] as const;
